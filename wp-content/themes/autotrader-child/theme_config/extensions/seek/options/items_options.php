...
$options = array(
    ...
    'dealers' => array(
        'parameter_name' => 'dealers',
        'template' => 'multi-taxonomy-select',
        'template_vars' => array(
            'label' => __('Select Dealer', 'tfuse'),
            'default_option' => __('Select Dealer', 'tfuse'),
        ),
        'settings' => array(
            'taxonomy' => TF_SEEK_HELPER::get_post_type() . '_dealers',
            'have_child' => true,
            'get_terms_args' => array(
                'hide_empty' => false,
                'order_by' => 'name',
        ...
        'sql_generator_options' => array(
            'search_on' => 'taxonomy',
            'search_on_id' => TF_SEEK_HELPER::get_post_type() . '_dealers',
        ),
    ),
