                ...
                if(sizeof($slist)):
                    ...
                    foreach($slist as $spost):
						...
						<div style="float:left;">
                            <div class="offer_image" style="float:none;">
							...
							<div class="offer_dealer" style="margin-left:10px;margin-top:10px;">
							<?php $dealers=get_the_terms( $spost['ID'], 'vehicle_dealers' );
					//print_r($dealers);
					if(is_array($dealers)){
					 ...
					 ?>
                            ...
                            <div class="offer_aside">
                                ...
                                <div class="offer_data">
                                    ...
                                    $price_number_str = number_format($spost['seek_property_price'], 0, ',','.');
                                    ?>
                                    <div class="offer_price"><?php tfuse_symbol_position($price_number_str, $price_symbol_str, $price_symbol_pos) ?></div>
                                    <?php
                                    $mileage_number = apply_filters( 'tfuse_mileage_number_format', number_format($spost['seek_property_mileage'], 0, '.', ','));
                                    ...
                                    <?php if( tfuse_is_date( $spost['seek_property_year'] ) ) : ?>
                                        <span class="offer_regist"><?php echo date("m/Y", strtotime($spost['seek_property_year'])); ?></span>
                                    <?php endif ?>
                                </div><!-- /.offer_data -->
                            </div><!-- /.offer_aside -->
