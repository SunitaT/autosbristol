...
<input type="hidden" value="<?php echo $post->ID ?>" id="post_id" name="post_id" ></input>
    ...
    <div class="form_col_3">
        <div class="row">
            ...
            <a href="http://twitter.com/share?url=<?php echo $link; ?>&amp;text=<?php the_title();?>&amp;count=horiztonal" class="btn_share"><img src="<?php echo $directory; ?>/images/btn_share_tweet.png" alt=""></a>
            <a href="http://www.facebook.com/sharer.php?u=<?php echo encodeURIComponent($link);?>%2F&t=<?php echo encodeURIComponent(get_the_title());?>" class="btn_share"><img src="<?php echo $directory; ?>/images/btn_share_like.png" alt=""></a>
            <a href="https://plus.google.com/share?url=<?php echo $link; ?>" class="btn_share"><img src="<?php echo $directory; ?>/images/btn_share_g1.png" alt=""></a>
        </div>
    </div><!--/ form col 3 -->
</form>