...
*/
    function tfuse_add_js()
    {
        ...
        wp_register_script( 'modernizr', tfuse_get_file_uri('/js/libs/modernizr.min.js'));
        ...
        wp_register_script( 'jquery.easing', tfuse_get_file_uri('/js/jquery.easing.min.js'), array('jquery'), '1.3', false );
        wp_enqueue_script( 'jquery.easing' );

        wp_register_script( 'hover', tfuse_get_file_uri('/js/hoverIntent.js'), array('jquery'), '1.0', false );
        ...
        wp_register_script( 'carouFredSel', tfuse_get_file_uri('/js/jquery.carouFredSel.min.js'), array('jquery'), '1.0', false );
        ...
        //rs-plugin
        wp_register_script( 'themepunch.plugins', tfuse_get_file_uri('/rs-plugin/js/jquery.themepunch.plugins.min.js'), array('jquery'), '2.0', false );
        wp_enqueue_script( 'themepunch.plugins' );

        wp_register_script( 'themepunch.revolution', tfuse_get_file_uri('/rs-plugin/js/jquery.themepunch.revolution.min.js'), array('jquery'), '2.0', false );
        ...
        wp_register_script( 'jScrollPane.min', tfuse_get_file_uri('/js/jquery.jscrollpane.min.js'), array('jquery'), '2.0', false );
        wp_enqueue_script( 'jScrollPane.min' );

        wp_register_script( 'offer_forms', tfuse_get_file_uri('/js/offer_forms.js'), array('jquery'), '1.0', true );
