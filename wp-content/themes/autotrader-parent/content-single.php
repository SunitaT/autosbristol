            ...
            <div class="post-meta">
                <?php if ( tfuse_page_options('enable_share_buttons',tfuse_options('enable_share_buttons',true) ) ) { ?>
                    <div class="post-share"><span><?php _e('Share:','tfuse'); ?></span>
                        <a href="https://plus.google.com/share?url=<?php the_permalink(); ?>" class="share_google"><?php _e('Google +1','tfuse'); ?></a>
                        <a href="http://www.facebook.com/sharer.php?u=<?php echo encodeURIComponent(get_permalink());?>%2F&t=<?php echo encodeURIComponent(get_the_title()); ?>" class="share_facebook"><?php _e('Facebook','tfuse'); ?></a>
                        <a href="http://twitter.com/share?url=<?php the_permalink(); ?>&amp;text=<?php the_title(); ?>&amp;count=horiztonal" class="share_twitter"><?php _e('Twitter','tfuse'); ?></a>
                    </div>
                <?php } ?>
