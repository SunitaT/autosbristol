<?php
    ...
    if ($attachments) {
        foreach ($attachments as $attachment){
			...
			$image_meta_value = get_post_meta($attachment->ID, 'image_title_key');
            $slider_images[] = array(
                'id'            => $attachment->ID,
                'title'         => apply_filters('the_title', $attachment->post_title),
                'order'         => $attachment->menu_order,
                'img_full'      => $attachment->guid,
				'image_title'	=> $image_meta_value[0]
            );
    ...
    <div class="gallery_images">
        <div id="gallery_images">
            ...
            <div class="gallery_image_item">
                <img src="<?php echo $slide['img_full']; ?>" title="<?php echo $slide['image_title']; ?>" alt="<?php echo $slide['image_title']; ?>">
	...
	if(!empty($slider_images)){ ?>
        <div class="gallery_thumbs">
            <div id="gallery_thumbs">
                <?php foreach($slider_images as $key=>$slide) : ?>
                    <a href="#"><img src="<?php echo $slide['img_full']; ?>" title="<?php echo $slide['image_title']; ?>" alt="<?php echo $slide['image_title']; ?>"></a>
                <?php endforeach; ?>
            </div>
