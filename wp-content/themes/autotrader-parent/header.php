    ...
    <div class="header_top">
        <div class="container">
            ...
            <div class="bookmarker"<?php echo(!$favoritesCount) ? ' style="display:none;"' : ''; ?>>
                <a href="<?php echo site_url('?s=~&tfseekfid=filter_search&favorites'); ?>"><span><?php echo $favoritesCount; ?></span> <?php printf( __('Saved %s', 'tfuse'), ($favoritesCount != 1) ? TF_SEEK_HELPER::get_option('seek_property_name_plural','Vehicles') : TF_SEEK_HELPER::get_option('seek_property_name_singular','Vehicle') ); ?></a>
            </div>
            <div class="logo">
