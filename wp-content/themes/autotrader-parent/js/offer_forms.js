...
function tfuse_send_contact_seller()
{
    jQuery('#offer_contact #send_seller_message').bind('click', function()
    {
        ...
        if (!my_error)
        {
            ...
            var datastring = 'action=tfuse_send_contact_seller&client_email=' + client_email + '&client_name=' + client_name + '&seller_message=' + seller_message + '&checkbox=' + checkbox + '&author_id=' + author_id;
