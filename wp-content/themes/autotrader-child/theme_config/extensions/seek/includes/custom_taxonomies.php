...
register_taxonomy($post_type . '_type', array($post_type), array(
        ...
        'show_ui' => true,
        'query_var' => true,
        'rewrite' => array('slug' => $post_type . '_type', 'with_front' => true),
...
register_taxonomy($post_type . '_fuel_type', array($post_type), array(
        ...
        'public'    => true,
        'query_var' => true,
        'rewrite' => array('slug' => $post_type . '_fuel', 'with_front' => false),
        'capabilities'  => array(
        )
    )
);
...
register_taxonomy($post_type . '_colors', array($post_type), array(
        ...
        'labels' => array
        (
            'name' => TF_SEEK_HELPER::get_option('seek_property_name_singular'). ' '.__( 'Exterior Colors','tfuse' ),
            'singular_name' => TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __( 'Exterior Color','tfuse' ),
            'search_items' =>  __( 'Search','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Exterior Colors','tfuse' ),
            'all_items' => __( 'All','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Exterior Colors','tfuse' ),
            'edit_item' => __( 'Edit','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Exterior Color','tfuse' ),
            'update_item' => __( 'Update','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Exterior Color','tfuse' ),
            'add_new_item' => __( 'Add New Exterior Color','tfuse' ),
            'new_item_name' => __( 'New','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Exterior Color','tfuse' ),
            'menu_name' => __('Exterior Colors','tfuse' ),
        ),
        'show_ui'   => true,
        'public'    => true,
        'query_var' => true,
        'rewrite' => array('slug' => $post_type . '_colors', 'with_front' => false),
        'capabilities'  => array(
        )
    )
);
...
register_taxonomy($post_type . '_statuses', array($post_type), array(
        ...
        'public'    => true,
        'query_var' => true,
        'rewrite' => array('slug' => $post_type . '_statuses', 'with_front' => true),
    )
);
//Gearboxes
register_taxonomy($post_type . '_gearboxes', array($post_type), array(
        ...
        'show_ui' => true,
        'query_var' => true,
        'rewrite' => array('slug' => $post_type . '_gearboxes', 'with_front' => true),
    )
);
//Interior Features
register_taxonomy($post_type . '_interior_features', array($post_type), array(
        ...
        'show_ui' => true,
        'query_var' => true,
        'rewrite' => array('slug' => $post_type . '_interior_features', 'with_front' => true),
    )
);
//Exterior Features
register_taxonomy($post_type . '_exterior_features', array($post_type), array(
        ...
        'show_ui' => true,
        'query_var' => true,
        'rewrite' => array('slug' => $post_type . '_exterior_features', 'with_front' => true),
    )
);
//Safely Features
register_taxonomy($post_type . '_safely_features', array($post_type), array(
        ...
        'labels' => array
        (
            'name' => TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __( 'Safely Features','tfuse' ),
            'singular_name' => TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __( 'Safely Feature','tfuse' ),
            'search_items' =>  __( 'Search','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Safely Features','tfuse' ),
            'all_items' => __( 'All','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Safely Features','tfuse' ),
            'edit_item' => __( 'Edit','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Safely Feature','tfuse' ),
            'update_item' => __( 'Update','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Safely Feature','tfuse' ),
            'add_new_item' => __( 'Add New Safely Feature','tfuse' ),
            'new_item_name' => __( 'New','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Safely Feature Name','tfuse' ),
            'menu_name' => __('Safely Features','tfuse' ),
        ),
        'capabilities'  => array(
            'manage_terms'              => 'manage_categories',
            'edit_terms'                => 'manage_categories',
        ...
        'show_ui' => true,
        'query_var' => true,
        'rewrite' => array('slug' => $post_type . '_safely_features', 'with_front' => true),
    )
);
//Extras
...
register_taxonomy($post_type . '_models', array($post_type), array(
    ...
    //Interior Colors
    register_taxonomy($post_type . '_interior_colors', array($post_type), array(
        'hierarchical' => false,
        'labels' => array
        (
         'name' => TF_SEEK_HELPER::get_option('seek_property_name_singular'). ' '.__( 'Interior Colors','tfuse' ),
         'singular_name' => TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __( 'Interior Color','tfuse' ),
         'search_items' =>  __( 'Search','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Interior Colors','tfuse' ),
         'all_items' => __( 'All','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Interior Colors','tfuse' ),
         'edit_item' => __( 'Edit','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Interior Color','tfuse' ),
         'update_item' => __( 'Update','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Interior Color','tfuse' ),
         'add_new_item' => __( 'Add New Color','tfuse' ),
         'new_item_name' => __( 'New','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Interior Color','tfuse' ),
         'menu_name' => __('Interior Colors','tfuse' ),
         ),
        'show_ui'   => true,
        'public'    => true,
        'query_var' => true,
        'rewrite' => array('slug' => $post_type . '_interior_colors', 'with_front' => false),
        'capabilities'  => array(
        )
        )
         );
    ...
    //Body Style
    register_taxonomy($post_type . '_body_style', array($post_type), array(
       'hierarchical' => false,
       'labels' => array
       (
        'name' => TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __( 'Body Styles','tfuse' ),
        'singular_name' => TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __( 'Body Style','tfuse' ),
        'search_items' =>  __( 'Search','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Body Styles','tfuse' ),
        'all_items' => __( 'All','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Body Styles','tfuse' ),
        'edit_item' => __( 'Edit','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Body Style','tfuse' ),
        'update_item' => __( 'Update','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Body Style','tfuse' ),
        'add_new_item' => __( 'Add New Body Style','tfuse' ),
        'new_item_name' => __( 'New','tfuse') .' '. TF_SEEK_HELPER::get_option('seek_property_name_singular') .' '. __('Body Style Name','tfuse' ),
        'menu_name' => __('Body Style','tfuse' ),
        ),
       'capabilities'  => array(
                                'manage_terms'              => 'manage_categories',
                                'edit_terms'                => 'manage_categories',
       ...
       'show_ui' => true,
       'query_var' => true,
       'rewrite' => array('slug' => $post_type . '_body_style', 'with_front' => true),
       )
                      );

    
	//Mechanical
		register_taxonomy($post_type . '_mechanicals', array($post_type), array(
	    'hierarchical'  => true,
	    'labels'        => array(
	                             'name'                      => __('Mechanicals','tfuse'),
	                             'singular_name'             => __('Mechanical','tfuse'),
	                             'search_items'              => __('Search Mechanicals','tfuse'),
	                             'all_items'                 => __('All Mechanicals','tfuse'),
	                             'parent_item'               => __('Parent Mechanical','tfuse'),
	                             'parent_item_colon'         => __('Parent Mechanical:','tfuse'),
	                             'edit_item'                 => __('Edit Mechanical','tfuse'),
	                             'update_item'               => __('Update Mechanical','tfuse'),
	                             'add_new_item'              => __('Add New Mechanical','tfuse'),
	                             'new_item_name'             => __('New Mechanical Name','tfuse'),
	                             'choose_from_most_used'     => __('Choose from the most used mechanicals','tfuse'),
	                             'separate_items_with_commas'=> __('Separate mechanicals with commas','tfuse')
	                             ),
	    'capabilities'  => array(
	                             'manage_terms'              => 'manage_categories',
	                             'edit_terms'                => 'assign_seek_terms',
    ...
    register_taxonomy($post_type . '_dealers', array($post_type), array(
	  'hierarchical'  => true,
	    'labels'        => array(
	                             'name'                      => __('Dealers','tfuse'),
	                             'singular_name'             => __('Dealer','tfuse'),
	                             'search_items'              => __('Search Dealers','tfuse'),
	                             'all_items'                 => __('All Dealers','tfuse'),
	                             'parent_item'               => __('Parent Dealer','tfuse'),
	                             'parent_item_colon'         => __('Parent Dealer','tfuse'),
	                             'edit_item'                 => __('Edit Dealer','tfuse'),
	                             'update_item'               => __('Update Dealer','tfuse'),
	                             'add_new_item'              => __('Add New Dealer','tfuse'),
	                             'new_item_name'             => __('New Dealer Name','tfuse'),
	                             'choose_from_most_used'     => __('Choose from the most used dealers','tfuse'),
	                             'separate_items_with_commas'=> __('Separate dealers with commas','tfuse')
	                             ),
	    'capabilities'  => array(
	                             'manage_terms'              => 'manage_categories',
	                             'edit_terms'                => 'assign_seek_terms',
