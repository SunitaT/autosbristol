...
foreach($options as $id=>$val){
    ...
    elseif($val['type']=='taxonomy')
    {
        if(sizeof($val['value']))
        {
            ...
            if( ($id == TF_SEEK_HELPER::get_post_type() . '_fuel_type') || ($id == TF_SEEK_HELPER::get_post_type() . '_locations') || ($id == TF_SEEK_HELPER::get_post_type() . '_models') || ($id == 'vehicle_type') || ($id == 'vehicle_gearboxes') || ($id == 'vehicle_statuses') || ($id == 'vehicle_mechanicals') || ($id == 'vehicle_body_style')){
                $result[]  =  $terms;
            }else
            {
