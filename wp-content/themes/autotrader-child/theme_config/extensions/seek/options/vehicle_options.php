...
if (!function_exists('tfuse_get_array_with_terms_for_a_taxonomy')){
    function tfuse_get_array_with_terms_for_a_taxonomy($taxonomy, $args=array('hide_empty'=> false, 'orderby'=>'count', 'order'=>'DESC')){
...
$options = array(
    ...
    array('name' => __('Images','tfuse'),
        'desc' => __('Manage the ' . mb_strtolower(TF_SEEK_HELPER::get_option('seek_property_name_singular')) . ' images by pressing the "Upload" button. These images will automatically form the slider from the property detail page', 'tfuse'),
    ...
    array('name' => __('Thumbnail <br>(300px x 210px)','tfuse'),
        'desc' => __('This is the thumbnail for your ','tfuse'). mb_strtolower(TF_SEEK_HELPER::get_option('seek_property_name_singular'), 'UTF-8') . __(' and it will be displayed in various sliders on the website and in the property listings. Upload one from your computer, or specify an online address for your image (Ex: http://yoursite.com/image.png).', 'tfuse'),
    ...
    array(
        ...
        'desc'          => sprintf(__('This price is calculated automatic. You can <a href="admin.php?page=themefuse">change the global VAT rate</a> in the Fuse Framework.', 'tfuse'), mb_strtolower(TF_SEEK_HELPER::get_option('seek_property_name_singular'), 'UTF-8')),
    ...
    array(
        ...
        'desc'          => __('Number of kilometers. Ex: 100000. Symbol for kilometers is set in <a href="admin.php?page=themefuse">Fuse Framework</a>','tfuse'),
    ...
    array(
        ...
        'desc'          => __('Motor capacity. Ex: 3200. Symbol for motor capacity is set in <a href="admin.php?page=themefuse">Fuse Framework</a>', 'tfuse'),
    ...
    // Consumption
    array('name' => __('Consumption ', 'tfuse') . TF_SEEK_HELPER::get_option('seek_property_consumption_symbol'),
        'desc' => __('Consumption to 100 km, consumtion symbol is set in <a href="admin.php?page=themefuse">Fuse Framework</a>', 'tfuse'),
    ...
    array('name' => __('Origin country','tfuse'),
    ...
    array('name' => __('Emission Class','tfuse'),
    ...
    array('name' => __('Vehicle type','tfuse'),
        'desc' => __('For add more types use <a href="edit-tags.php?taxonomy=' .  TF_SEEK_HELPER::get_post_type() .  '_type&post_type=' . TF_SEEK_HELPER::get_post_type() . '">this</a> link.', 'tfuse'),
    ...
    array('name' => __('Fuel type','tfuse'),
        'desc' => __('For add more fuel types use <a href="edit-tags.php?taxonomy=' .  TF_SEEK_HELPER::get_post_type() .  '_fuel_type&post_type=' . TF_SEEK_HELPER::get_post_type() . '">this</a> link.', 'tfuse'),
    ...
    array('name' => __('Gearbox type', 'tfuse'),
        'desc' => __('For add more types of geaboxes use <a href="edit-tags.php?taxonomy=' .  TF_SEEK_HELPER::get_post_type() .  '_gearboxes&post_type=' . TF_SEEK_HELPER::get_post_type() . '">this</a> link.', 'tfuse'),
    ...
    array('name' => __('Status','tfuse'),
        'desc' => __('For add more types of statuses use <a href="edit-tags.php?taxonomy=' .  TF_SEEK_HELPER::get_post_type() .  '_statuses&post_type=' . TF_SEEK_HELPER::get_post_type() . '">this</a> link.', 'tfuse'),
    ...
    array('name' => __('Exterior Color','tfuse'),
        'desc' => __('For add more colors use <a href="edit-tags.php?taxonomy=' .  TF_SEEK_HELPER::get_post_type() .  '_colors&post_type=' . TF_SEEK_HELPER::get_post_type() . '">this</a> link.', 'tfuse'),
...
/*    array('name' => __('Interior Color','tfuse'),
        'desc' => __('For add more colors use <a href="edit-tags.php?taxonomy=' .  TF_SEEK_HELPER::get_post_type() .  '_interior_colors&post_type=' . TF_SEEK_HELPER::get_post_type() . '">this</a> link.', 'tfuse'),
        'id' => TF_THEME_PREFIX . '_interior_color',
        'value' => '',
        'type' => 'select',
        'options'   => tfuse_get_array_with_terms_for_a_taxonomy(TF_SEEK_HELPER::get_post_type() . '_interior_colors'),
        'searchable'    => false,
        'divider'   => true
    ),*/
    array('name' => __('Registration Year','tfuse'),
