<?php
if ($slider['general']['slider_text_position'] == 'left') {
    $class = 'img_right';
    $c = 0;
} else if ($slider['general']['slider_text_position'] == 'right') {
    $class = '';
    $c = 0;
} else {
    $class = '';
                    ...
                    <div class="slide_item <?php echo $class; ?>">
                        <div class="slide_img">
                            <?php if ($slide['slide_type_slide'] == 'image') { ?>
                                <?php if ($link != '') { ?><img src="<?php echo $slide['slide_src']; ?>" alt="" onclick="window.location = '<?php echo $link; ?>'" style="cursor:pointer;"><?php } else { ?><a href="<?php echo $slide['slide_link_title']; ?>"><img src="<?php echo $slide['slide_src']; ?>" alt=""></a><?php } ?>
                                <?php
                            } else
                                echo $slide['slide_video_frame'];
                            ?>
                        </div>
                        <?php
                        if ($link != '') {
                            ...
                            <div class="slide_text">
                                ...
                                <?php
                                if (isset($slide['slide_list']) && !empty($slide['slide_list'])) {
                                    $list = explode("\n", $slide['slide_list']);
                                    foreach ($list as $item)
                                        echo '<div class="info_line">' . $item . '</div>';
                                }
                                ?>
                                <div class="info_price"><?php echo $link; ?></a> <a href="<?php echo $link; ?>" class="save-item">Save</a></div>
                            </div>
                        <?php } else {
                            ?>
